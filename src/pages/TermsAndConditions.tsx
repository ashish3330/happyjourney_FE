          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">
                Welcome to HappyJourney, a brand of HappyJourney Services a Proprietorship, registered under the Indian Companies Act. By using our services, website (thehappyjourneyy.in), mobile apps, or call center, you agree to these Terms and Conditions. We are committed to transparent and ethical practices. Some services may have additional terms, which will be provided and become part of your agreement if used.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-600">
                ...
                <li><strong>Website</strong>: http://thehappyjourneyy.in, where we offer products and services.</li>
