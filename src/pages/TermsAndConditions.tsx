          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">
                Welcome to HappyJourney, a brand of HappyJourney Services Private Limited, registered under the Indian Companies Act. By using our services, website (thehappyjourneyy.in), mobile apps, or call center, you agree to these Terms and Conditions. We are committed to transparent and ethical practices. Some services may have additional terms, which will be provided and become part of your agreement if used.
              </p>
            </div>
          </div>
