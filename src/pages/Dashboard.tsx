    ...
    <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6 bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <Card className="mb-6 border border-teal-100">
        <CardHeader className="bg-teal-50">
          ...
          <p className="text-sm text-teal-600">Monitor and analyze vendor and station performance</p>
        </CardHeader>
      </Card>
      ...
      <Card className="mb-6 shadow-md border border-teal-100">
        <CardHeader className="bg-teal-50">
          <CardTitle className="text-lg font-semibold text-teal-800">Filter Analytics</CardTitle>
        </CardHeader>
      ...
      {selectedVendor && monthlySales.length > 0 && (
        <Card className="mb-6 shadow-md border border-teal-100">
          <CardHeader className="bg-teal-50">
            <CardTitle className="text-lg font-semibold text-teal-800">Monthly Sales Overview</CardTitle>
          </CardHeader>
          <CardContent className="p-3 sm:p-6">
            <div className="h-96">
              <Chart
      ...
      <Card className="mb-6 shadow-md border border-teal-100">
        <CardHeader className="bg-teal-50">
          <CardTitle className="text-lg font-semibold text-teal-800">Vendors Sales Overview</CardTitle>
        </CardHeader>
        <CardContent className="p-3 sm:p-6">
      ...
      {selectedVendor && (
        <Card className="shadow-md border border-teal-100">
          <CardHeader className="bg-teal-50">
            <CardTitle className="text-lg font-semibold text-teal-800">Top Selling Items</CardTitle>
          </CardHeader>
          <CardContent className="p-3 sm:p-6">
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500">
