    ...
    <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
      {loading ? (
        ...
        <Card className="w-full shadow-md border border-teal-100">
          <CardHeader className="bg-teal-50">
            <CardTitle className="text-xl sm:text-2xl font-bold text-teal-800">Complaints Dashboard</CardTitle>
          </CardHeader>
          <CardContent className="p-3 sm:p-6">
            ...
            {listData.length > 0 ? (
                ...
                {isMobile ? (
                  <div className="space-y-3">
                    {listData.map((item, index) => (
                      <Card key={item.complaintId} className="p-3 border border-teal-100">
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div>
                            <p className="text-xs text-teal-600">Complaint ID</p>
                          ...
                          <div className="col-span-2">
                            <p className="text-xs text-teal-600">Description</p>
                  ...
                  <table className="min-w-full divide-y divide-teal-200">
                    <thead className="bg-teal-50">
                      <tr>
                        ...
                        <th className="px-3 py-2 text-sm font-medium text-teal-900 text-left">Complaint ID</th>
                        ...
                        <th className="px-3 py-2 text-sm font-medium text-teal-900 text-left">Description</th>
                    ...
                    <tbody className="divide-y divide-teal-200">
                      {listData.map((item, index) => (
                        <tr key={item.complaintId} className="hover:bg-teal-50 transition-colors">
              ...
              <div className="flex flex-col items-center justify-center py-10">
                <h2 className="text-lg sm:text-xl font-semibold text-teal-600">No Complaints Found</h2>
                <p className="text-sm text-teal-500 mt-2">Try adjusting your filters or adding new complaints.</p>
              </div>
            )}
          </CardContent>
        </Card>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-sm p-4">
          <DialogHeader>
            <DialogTitle className="text-teal-800">Update Complaint Status</DialogTitle>
          </DialogHeader>
          <Select
